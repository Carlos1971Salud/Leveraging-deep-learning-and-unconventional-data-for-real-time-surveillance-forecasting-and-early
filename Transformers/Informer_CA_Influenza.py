...
the number of Influenza cases in Ontario, Canada. 
...
p = 'ON' # Only Ontario
data1 = pd.DataFrame(data= {'cases':cases['ON'], 'gt':gt['ON'], 'o1':o1['ON'], 
                            #'o2':o2['ON'], 'rain':rain['ON'], 'prec':prec['ON'],
                            'temp':temp['ON']})
